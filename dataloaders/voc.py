...
class VOC(BaseDataLoader):
    def __init__(self, num_classes, data_dir, batch_size, split, crop_size=None, base_size=None, scale=True, num_workers=1, val=False,
                    shuffle=False, flip=False, rotate=False, blur= False, augment=False, drop_last=False, val_split= None, return_id=False):
